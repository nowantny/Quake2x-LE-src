...
qboolean	CL_CheckOrDownloadFile (char *filename)
{
	...
	char	name3[MAX_OSPATH];
	char	name4[MAX_OSPATH];
	char	name5[MAX_OSPATH];
...
//		Com_Printf ("100%%\n");
		...
		strcpy(name4, newn);
		strcpy(name5, replace(name4,"/","\\"));

		r = rename (name3, name5);
		if (r)
