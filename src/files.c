/* $Id: files.c,v 1.4 2002/12/23 08:15:00 jaq Exp $
 *
 * quake filesystem
 *
...
//
	...
	// check a file in the directory tree
			...
			strcpy(netpath2, replace(netpath, "/", "\\"));

			*file = fopen (netpath2, "rb");
			if (!*file)
				continue;
...
void FS_InitFilesystem (void)
{
	...
	//
	fs_basedir = Cvar_Get ("basedir", "D:", CVAR_NOSET);
